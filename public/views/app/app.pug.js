...
export default function 
          appComponent(locals) {var pug_html = "", pug_mixins = {}, pug_interp;let source = "/static/images/";
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"message__block\"\u003E\u003Cdiv class=\"message\"\u003E\u003Cdiv class=\"avatar\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"info\"\u003E\u003Cp class=\"username\"\u003EUsername\u003C\u002Fp\u003E\u003Cp class=\"message\"\u003EVery long message\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"quantity__block\"\u003E\u003Cp class=\"quantity\"\u003E1\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
pug_html = pug_html + "\u003Cdiv class=\"content\"\u003E\u003Cdiv class=\"profile\"\u003E\u003Cdiv class=\"content__profile\"\u003E\u003Cdiv class=\"profile__user\"\u003E\u003Cdiv class=\"user__avatar\"\u003E\u003Cimg" + (" class=\"avatar__img\""+pug_attr("src", avatar, true, false)) + "\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"user__info\"\u003E\u003Cdiv class=\"info\"\u003E";
pug_mixins["userInfo"]("David Jones, " ,23, "New York");
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"settings\"\u003E\u003Cdiv class=\"settings__link\"\u003E\u003Cimg" + (" class=\"link__img\""+pug_attr("src", `${settings}`, true, false)) + "\u002F\u003E\u003Ca class=\"settings__edit\" href=\"\u002Fprofile\" id=\"settings__edit\"\u003EEdit profile\u003C\u002Fa\u003E\u003Ca class=\"logout\" href=\"\u002F\" id=\"logout\"\u003ELogout\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"profile__navigation\"\u003E\u003Cdiv class=\"navigation__buttons\" id=\"navigation__buttons\"\u003E\u003Cdiv class=\"buttons__message\"\u003E\u003Cimg" + (" class=\"buttons__message__icon\""+pug_attr("src", `${MsgLight}`, true, false)) + "\u002F\u003E\u003Ca class=\"message__link\" href=\"\"\u003EMessage\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"buttons__matches\"\u003E\u003Cimg" + (" class=\"buttons__matches__icon\""+pug_attr("src", `${Matches}`, true, false)) + "\u002F\u003E\u003Ca class=\"matches__link\" href=\"\"\u003EMatches\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"navigation__field\" id=\"navigation__field\"\u003E";
pug_mixins["createMessage"]();
pug_mixins["createMessage"]();
pug_mixins["createMessage"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"navigation__profile\" id=\"navigation__profile\"\u003E\u003Cform id=\"editProfile\"\u003E\u003Cdiv class=\"nameBlock\"\u003E\u003Cdiv class=\"block\"\u003E\u003Cp class=\"nameP\"\u003EName:\u003C\u002Fp\u003E\u003Cinput class=\"nameInput form__input__require\" type=\"text\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"error\"\u003E\u003Cp class=\"nameInput__error _error\"\u003EError\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"surnameBlock\"\u003E\u003Cdiv class=\"block\"\u003E\u003Cp class=\"surnameP\"\u003ESurname:\u003C\u002Fp\u003E\u003Cinput class=\"surnameInput form__input__require\" type=\"text\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"error\"\u003E\u003Cp class=\"surnameInput__error _error\"\u003EError\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"ageBlock\"\u003E\u003Cdiv class=\"block\"\u003E\u003Cp class=\"ageP\"\u003EAge:\u003C\u002Fp\u003E\u003Cinput class=\"ageInput form__input__require\" type=\"text\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"error\"\u003E\u003Cp class=\"ageInput__error _error\"\u003EError\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"cityBlock\"\u003E\u003Cdiv class=\"block\"\u003E\u003Cp class=\"cityP\"\u003ECity:\u003C\u002Fp\u003E\u003Cinput class=\"cityInput form__input__require\" type=\"text\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"error\"\u003E\u003Cp class=\"cityInput__error _error\"\u003EError\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"photoBlock\"\u003E\u003Cp class=\"photoP\"\u003EChange photo:\u003C\u002Fp\u003E\u003Cinput class=\"photo\" type=\"file\"\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"buttonsBlock\"\u003E\u003Cbutton class=\"cancel\" type=\"submit\" id=\"cancel__button\"\u003ECancel\u003C\u002Fbutton\u003E\u003Cbutton class=\"save\" type=\"submit\"\u003ESave changes\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fform\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"content__feed\"\u003E\u003Cdiv class=\"feed__people\"\u003E\u003Cdiv class=\"people__photo\"\u003E\u003Cimg" + (pug_attr("src", `${source}userPhoto.png`, true, false)) + "\u002F\u003E\u003Cdiv class=\"navigation__icons\" id=\"navigation__icons\"\u003E";
